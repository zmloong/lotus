...
import (
	...
	"github.com/zmloong/lotus/lib"
	"github.com/zmloong/lotus/lib/modules/gate"
	"github.com/zmloong/lotus/lib/s_comps"
...
func (this *MComp_GateComp) handlemsg(ctx context.Context, cancel context.CancelFunc, agrs ...interface{}) {
	...
	defer lotus.Recover(fmt.Sprintf("MComp_GateComp ReceiveMsg msg:%v", msg)) //打印消息处理异常信息
