...
import (
	...
	"github.com/zmloong/lotus/base"
	"github.com/zmloong/lotus/core"
	"github.com/zmloong/lotus/core/cbase"
	"github.com/zmloong/lotus/lib/modules/monitor"
	...
	"github.com/zmloong/lotus/utils/container/sortslice"
	"github.com/zmloong/lotus/utils/container/version"
)
...
func (this *ClusterService) RpcInvokeById(sId string, rkey core.Rpc_Key, iscall bool, arg ...interface{}) (result interface{}, err error) {
	defer lotus.Recover(fmt.Sprintf("RpcInvokeById sId:%s rkey:%v iscall %v arg %v", sId, rkey, iscall, arg))
	this.lock.RLock()
...
func (this *ClusterService) RpcInvokeByIds(sId []string, rkey core.Rpc_Key, iscall bool, arg ...interface{}) (results map[string]*base.Result, err error) {
	...
	defer lotus.Recover(fmt.Sprintf("RpcInvokeByIds sId:%v rkey:%v iscall %v arg %v", sId, rkey, iscall, arg))
	this.lock.RLock()
	defer this.lock.RUnlock()
...
func (this *ClusterService) RpcInvokeByType(sType string, rkey core.Rpc_Key, iscall bool, arg ...interface{}) (result interface{}, err error) {
	defer lotus.Recover(fmt.Sprintf("RpcInvokeByType sType:%s rkey:%v iscall %v arg %v", sType, rkey, iscall, arg))
	this.lock.RLock()
	defer this.lock.RUnlock()
...
func (this *ClusterService) RpcInvokeByIp(sIp, sType string, rkey core.Rpc_Key, iscall bool, arg ...interface{}) (result interface{}, err error) {
	defer lotus.Recover(fmt.Sprintf("RpcInvokeByIp sIp:%s sType:%s rkey:%v iscall %v arg %v", sIp, sType, rkey, iscall, arg))
	this.lock.RLock()
	defer this.lock.RUnlock()
...
func (this *ClusterService) RpcInvokeByIps(sIp []string, sType string, rkey core.Rpc_Key, iscall bool, arg ...interface{}) (results map[string]*base.Result, err error) {
	...
	defer lotus.Recover(fmt.Sprintf("RpcInvokeByIps sIp:%v sType:%s rkey:%v iscall %v arg %v", sIp, sType, rkey, iscall, arg))
	this.lock.RLock()
	defer this.lock.RUnlock()
...
func (this *ClusterService) ReleaseRpc(rkey core.Rpc_Key, arg ...interface{}) {
	defer lotus.Recover(fmt.Sprintf("ReleaseRpc rkey:%v arg %v", rkey, arg))
